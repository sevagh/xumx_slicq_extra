...
time $pybin evaloracle/ideal_mask.py --eval_dir results-debug ./config_debug.json
$pybin evaloracle/aggregate.py ./results-debug/* --out=results-debug/data.pandas
$pybin evaloracle/boxplot.py ./results-debug/data.pandas ./results-debug/boxplot.pdf

#$pybin evaloracle/ideal_mask.py --eval_dir results-octave ./config_octave.json
...
#
#$pybin evaloracle/ideal_mask.py --eval_dir results-mel ./config_mel.json
...
#
#$pybin evaloracle/ideal_mask.py --eval_dir results-bark ./config_bark.json
...
#
#$pybin evaloracle/ideal_mask.py --eval_dir results-log ./config_log.json
