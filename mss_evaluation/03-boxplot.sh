...
$pybin "${scriptdir}/aggregate.py" --out=./exp-04-trained-models-2022/data.pandas ./exp-04-trained-models-2022/*
$pybin "${scriptdir}/boxplot.py" ./exp-04-trained-models-2022/data.pandas ./exp-04-trained-models-2022/boxplot.pdf
$pybin "${scriptdir}/boxplot.py" --print-median-only ./exp-04-trained-models-2022/data.pandas ./exp-04-trained-models-2022/boxplot.pdf
