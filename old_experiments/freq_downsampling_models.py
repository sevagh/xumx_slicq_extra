...
class _SlicedUnmix(nn.Module):
    def __init__(
        ...
        if nb_f_bins < 5:
            ...
            freq_filter_2 = 1
            freq_stride_2 = 1
            output_padding_freq_1 = 0
            output_padding_freq_2 = 0
        elif nb_f_bins < 10:
            freq_filter_1 = 3
            freq_stride_1 = 3
            freq_filter_2 = 1
            freq_stride_2 = 1
            output_padding_freq_1 = 2
            output_padding_freq_2 = 0
        else:
            freq_filter_1 = 5
            freq_stride_1 = 3
            ...
            freq_stride_2 = 3
            output_padding_freq_1 = 2
            output_padding_freq_2 = 1

        window = nb_t_bins
        hop = window // 2

        time_filter_1 = window
        time_stride_1 = hop
        output_padding_time_1 = 0

        time_filter_2 = 3
        time_stride_2 = 3
        output_padding_time_2 = 2

        encoder_1 = nn.Sequential(*[
            Conv2d(
                nb_channels,
                hidden_size_1,
                (freq_filter_1, time_filter_1),
                stride=(freq_stride_1, time_stride_1),
                bias=False,
            ),
        ...
        encoder_2 = nn.Sequential(*[
            Conv2d(
                hidden_size_1,
                hidden_size_2,
                (freq_filter_2, time_filter_2),
                stride=(freq_stride_2, time_stride_2),
                bias=False,
            ),
        ...
        decoder_1 = nn.Sequential(*[
            ConvTranspose2d(
                ...
                (freq_filter_2, time_filter_2),
                stride=(freq_stride_2, time_stride_2),
                output_padding=(output_padding_freq_2, output_padding_time_2),
                bias=False,
            ),
            BatchNorm2d(hidden_size_1),
            ReLU(),
        ...
        decoder_2 = nn.Sequential(*[
            ConvTranspose2d(
                ...
                (freq_filter_1, time_filter_1),
                stride=(freq_stride_1, time_stride_1),
                output_padding=(output_padding_freq_1, output_padding_time_1),
                bias=True,
            ),
            Sigmoid()
        ])
