...
class SlicedUnmixBass(nn.Module):
    def __init__(
        self,
        slicq_sample_input,
        input_mean=None,
        ...
        super(SlicedUnmixBass, self).__init__()
...
class UnmixBass(nn.Module):
    def __init__(
        ...
        super(UnmixBass, self).__init__()

        self.sliced_umx_bass = nn.ModuleList()
    ...
    def forward(self, x) -> Tensor:
        futures_bass = [
            torch.jit.fork(self.sliced_umx_bass[i], Xmag_block)
