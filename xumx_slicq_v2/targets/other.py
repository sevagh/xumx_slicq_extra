...
class SlicedUnmixOther(nn.Module):
    def __init__(
        self,
        slicq_sample_input,
        input_mean=None,
        ...
        super(SlicedUnmixOther, self).__init__()
...
class UnmixOther(nn.Module):
    def __init__(
        ...
        super(UnmixOther, self).__init__()

        self.sliced_umx_other = nn.ModuleList()
    ...
    def forward(self, x) -> Tensor:
        futures_other = [
            torch.jit.fork(self.sliced_umx_other[i], Xmag_block)
