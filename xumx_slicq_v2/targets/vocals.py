...
class SlicedUnmixVocals(nn.Module):
    def __init__(
        self,
        slicq_sample_input,
        input_mean=None,
        ...
        super(SlicedUnmixVocals, self).__init__()
...
class UnmixVocals(nn.Module):
    def __init__(
        ...
        super(UnmixVocals, self).__init__()

        self.sliced_umx_vocals = nn.ModuleList()
    ...
    def forward(self, x) -> Tensor:
        futures_vocals = [
            torch.jit.fork(self.sliced_umx_vocals[i], Xmag_block)
