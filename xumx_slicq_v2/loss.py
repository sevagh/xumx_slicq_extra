...
class LossCriterion:
    ...
    def __call__(
        ...
        # 4C2 Combination Losses
        mse_loss_5 = _custom_mse_loss(
            pred_magnitude_1 + pred_magnitude_2, target_magnitude_1 + target_magnitude_2
        )
        mse_loss_6 = _custom_mse_loss(
            pred_magnitude_1 + pred_magnitude_3, target_magnitude_1 + target_magnitude_3
        )
        mse_loss_7 = _custom_mse_loss(
            pred_magnitude_1 + pred_magnitude_4, target_magnitude_1 + target_magnitude_4
        )
        mse_loss_8 = _custom_mse_loss(
            pred_magnitude_2 + pred_magnitude_3, target_magnitude_2 + target_magnitude_3
        )
        mse_loss_9 = _custom_mse_loss(
            pred_magnitude_2 + pred_magnitude_4, target_magnitude_2 + target_magnitude_4
        )
        mse_loss_10 = _custom_mse_loss(
            pred_magnitude_3 + pred_magnitude_4, target_magnitude_3 + target_magnitude_4
        )

        # 4C3 Combination Losses
        mse_loss_11 = _custom_mse_loss(
            pred_magnitude_1 + pred_magnitude_2 + pred_magnitude_3,
            target_magnitude_1 + target_magnitude_2 + target_magnitude_3,
        )
        mse_loss_12 = _custom_mse_loss(
            pred_magnitude_1 + pred_magnitude_2 + pred_magnitude_4,
            target_magnitude_1 + target_magnitude_2 + target_magnitude_4,
        )
        mse_loss_13 = _custom_mse_loss(
            pred_magnitude_1 + pred_magnitude_3 + pred_magnitude_4,
            target_magnitude_1 + target_magnitude_3 + target_magnitude_4,
        )
        mse_loss_14 = _custom_mse_loss(
            pred_magnitude_2 + pred_magnitude_3 + pred_magnitude_4,
            target_magnitude_2 + target_magnitude_3 + target_magnitude_4,
        )
