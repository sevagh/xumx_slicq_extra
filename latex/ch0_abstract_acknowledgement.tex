...
\begin{abstract}
	I believe that all software should be free, libre, open, open-source. Hidden knowledge is the antithesis of science and progress. I owe much of my learning journey to software that has been made both free to read and free to use, and I have aimed to release every line of code I ever wrote in support of the publication of this thesis, and any and all self-learning, as fully open-source.
\end{abstract}
