...
\begin{frame}
	...
	\begin{enumerate}
		\item
			Electrical engineering background, Linux engineer at Pandora (U.S. music streaming service)
		\item
...
\begin{frame}
	...
	\item
		Long window (4096) + short window (256) STFT in HPSS\footfullcite{driedger}
	\item
...
\begin{frame}
	...
	\item
		STFT-like operations with windows that vary with time
	\item
