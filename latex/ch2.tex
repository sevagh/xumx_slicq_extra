...
\begin{figure}[ht]
	\centering
	\subfloat[UMX Bi-LSTM architecture.\protect\footnotemark]{\includegraphics[width=0.9375\textwidth]{./images-neural/umx.png}}\\
	\subfloat[Simple DNN architecture for music source separation {\parencite[262]{umxorig1}}.]{\includegraphics[width=0.9375\textwidth]{./images-neural/typical_simple_mss_dnn.png}}
...
\begin{figure}[ht]
	\centering
	\subfloat[Multi-domain loss (MDL), showing the frequency-domain MSE loss from the spectrograms and time-domain SDR loss from the waveforms summed with a mixing coefficient $\alpha$ from equation \eqref{equation:totalloss}.]{\includegraphics[width=0.9375\textwidth]{./images-neural/xumx1_2.png}}\\
