...
There are four independent Bi-LSTM neural networks, \hlblu{shown in Figure} \ref{fig:umxes2}, for each of the four sources: vocals, bass, drums, and other. The four Bi-LSTM models are trained until the loss stops improving. At this point, UMX is ready to perform inference.
