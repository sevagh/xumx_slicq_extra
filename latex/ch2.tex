...
\begin{figure}[ht]
	\centering
	\subfloat[Mutually exclusive formulations of time and frequency by two extremes, the unit impulse (bottom left) and the 0 Hz cosine DFT spectrum (top right)]{\includegraphics[width=0.65\textwidth]{./images-tftheory/gabor13.png}}\\
	\subfloat[The periodicity of the sine wave is more apparent with a longer $\Delta t$, at the expense of temporally localized samples]{\includegraphics[width=0.65\textwidth]{./images-tftheory/gabor2.png}}
...
\begin{figure}[ht]
	\centering
	\subfloat[NSGT, Variable-Q scale, 100 bins]{\includegraphics[width=0.675\textwidth]{./images-gspi/gspi_nsgt_vqlog_100.png}}\\
	\subfloat[NSGT, Variable-Q scale, 500 bins]{\includegraphics[width=0.675\textwidth]{./images-gspi/gspi_nsgt_vqlog_500.png}}
	\caption{Variable-Q NSGT spectrograms of the glockenspiel signal}
...
\begin{figure}[ht]
	...
	\label{fig:bunchansgts3}
\end{figure}

\begin{figure}[ht]
	\centering
	\subfloat[NSGT, Bark scale, 100 bins]{\includegraphics[width=0.675\textwidth]{./images-gspi/gspi_nsgt_bark_100.png}}\\
	\subfloat[NSGT, Bark scale, 500 bins]{\includegraphics[width=0.675\textwidth]{./images-gspi/gspi_nsgt_bark_500.png}}
	\caption{Bark-scale NSGT spectrograms of the glockenspiel signal}
	\label{fig:bunchansgts4}
\end{figure}
...
\begin{figure}[ht]
	\centering
	\subfloat[Percussive estimate]{{\includegraphics[width=0.675\textwidth]{./images-hpss/perc_stft.png} }}\\
	\subfloat[Harmonic estimate]{{\includegraphics[width=0.675\textwidth]{./images-hpss/harm_stft.png} }}\\
	\subfloat[Residual estimate]{{\includegraphics[width=0.675\textwidth]{./images-hpss/resi_stft.png} }}
...
\begin{figure}[ht]
	...
	\caption{WMDCTLasso tonal/transient separation\protect\footnotemark}
...
\begin{figure}[ht]
	\centering
	\subfloat[Open-Unmix Bi-LSTM architecture\protect\footnotemark]{\includegraphics[width=\textwidth]{./images-neural/umx.png}}\\
	\subfloat[Simple DNN architecture for MSS {\parencite[262]{umxorig1}}]{\includegraphics[width=\textwidth]{./images-neural/typical_simple_mss_dnn.png}}
