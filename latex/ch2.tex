...
\begin{figure}[ht]
	\centering
		...
		\centering
		\subfloat[]{UMX Bi-LSTM architecture.\footnote[1]{\url{https://github.com/sigsep/open-unmix-pytorch\#-the-model-for-one-source}}}{\includegraphics[width=0.9375\textwidth]{./images-neural/umx.png}}\\
