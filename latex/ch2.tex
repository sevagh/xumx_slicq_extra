...
\todo{
	chapter notes:\\
	remove all traces of MDX\\
	remove all traces of tonal/transient\\
	remove all traces of wavelets\\
...
\todo[inline]{Chapter roadmap here}
