...
In the upcoming section \ref{sec:raggedvszpmatrix}, we will justify why the ragged form of the sliCQT was chosen instead of the zero-padded matrix form in the final neural network, xumx-sliCQ.
...
\subsubsection{sliCQT ragged and zero-padded matrix comparison}
\label{sec:raggedvszpmatrix}

\todo[inline]{you know what to do}

\subsubsection{Bi-LSTM and CNN architecture comparison}
\label{sec:lstmvsconv}
