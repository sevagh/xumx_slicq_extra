...
The proposed adaptation of Open-Unmix \parencite{umx} to use the sliCQ Transform (sliCQT) is named xumx-sliCQ,\footnote{\url{https://github.com/sevagh/xumx-sliCQ}} and is the subject and main result of this thesis.
...
\begin{figure}[!ht]
	\centering
	\subfloat[GitHub commit browser]{\includegraphics[width=0.9\textwidth]{./images-misc/ghcommitbrowser.png}}\\
	\subfloat[View file and line changes in each commit]{\includegraphics[width=0.85\textwidth]{./images-misc/ghcommitsingle.png}}
