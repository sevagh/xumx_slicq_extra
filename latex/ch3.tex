...
\explanation{just made this a subsection}
...
\explanation{The relevance here is to make clear that the upstream BSS metrics library does not include my speedups, and that its available only in my copy}
...
\explanation{how these were implemented? copied from umx originally, and the torch code of the CDAE paper}
...
\explanation{original contribution? yes. how do i know it was correct? well, 3.6 dB isn't world-beating, but it's probably better than random garbage, indicating my network is doing something correctly}
...
\explanation{this is different now that i shifted the burden of explaining UMX vs. X-UMX to chapter 2}
