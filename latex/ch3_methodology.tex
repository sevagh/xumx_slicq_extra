...
To supplement the octave and log scale, the variable-Q scale (\cite{variableq1, variableq2}) was implemented.\footnote{\url{https://github.com/sevagh/nsgt/blob/master/nsgt/fscale.py\#L105}}
...
The next frequency scale added was the Bark psychoacoustic scale, to complement the included mel scale. One of the possible formulas used to approximate the Bark frequency from the Hz frequency is the following (\cite{barktan}):
\begin{align}
	\nonumber & f_{\text{bark}} = 6 \cdot arcsinh(\frac{f_{\text{Hz}}}{600})
\end{align}
