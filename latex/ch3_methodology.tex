...
Describe open-unmix-pytorch (LSTM vs. gh template)\\
...
Open-Unmix is a deep neural network which uses the STFT to estimate 4 targets: bass, vocals, drums, and other. It is the hypothesis and hope of this thesis that using a sliCQT spectrogram, which can contain more musical information than the STFT from its adaptive time-frequency resolution, will allow the Open-Unmix network to perform music demixing more effectively.
