...
\section{sliCQT dimensionality and size experiments}
\label{appendix:slicqdim}

\subsection{Fixing $f_{\text{max}}$ to the Nyquist rate}
\label{appendix:slicqdim1}

\subsection{STFT and sliCQT compared}
