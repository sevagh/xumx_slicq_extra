...
\begin{frame}
	...
	\begin{figure}[ht]
		\centering
		\vspace{-1.25em}
		\subfloat{\includegraphics[height=2.25cm]{./images-gspi/glock_stft_1024.png}}
		\subfloat{\includegraphics[height=2.25cm]{./images-gspi/glock_stft_4096.png}}
		\subfloat{\includegraphics[height=2.25cm]{./images-gspi/glock_stft_256.png}}\\
		\vspace{-1.5em}
		\subfloat{\includegraphics[height=2.25cm]{./images-tftheory/gabor3_2.png} \includegraphics[height=2.05cm]{./images-tftheory/gabor4.png}}
		\vspace{-1em}
	\end{figure}
