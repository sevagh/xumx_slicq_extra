...
The second variable, the quantization levels of the amplitude, 

An A/D or ADC (analog-to-digital converter) circuit and its operation on a waveform is shown in figure \ref{fig:adccircuit}. Finally, a continuous-time pressure waveform, and the sequence representing its digitally sampled discrete-time version, are shown in figure \ref{fig:discretecontinuous}.

\begin{figure}[ht]
	\centering
	\subfloat[Analog-to-digital converter (ADC)]{\includegraphics[height=2.2cm]{./images-tftheory/adc1.png}}
	\hspace{0.1em}
	\subfloat[ADC details with the ideal continuous-discrete (C/D) circuit]{\includegraphics[height=2.2cm]{./images-tftheory/adc2.png}}\\
	\subfloat[Waveform results of the ADC process]{\includegraphics[width=\textwidth]{./images-tftheory/adc3.png}}\\
