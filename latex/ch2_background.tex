...
\begin{figure}[ht]
	\centering
	\subfloat[2048-point DFT, $\mathit{df} = 21.533 Hz$]{\includegraphics[width=0.9\textwidth]{./images-gspi/gspi_dft.png}}\\
	\subfloat[262144-point DFT, $\mathit{df} = 0.168 Hz$]{\includegraphics[width=0.9\textwidth]{./images-gspi/gspi_dft_bigger.png}}
