...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.825\textwidth,trim={1cm 0.25cm 1cm 0.25cm},clip]{./images-gspi/glock_waveform.png}
...
\begin{figure}[ht]
	\centering
	\subfloat[STFT, 128-sample Hamming]{\includegraphics[width=0.5\textwidth]{./images-gspi/glock_hamm_128.png}}
	\subfloat[Gabor transform, 128-sample Gaussian]{\includegraphics[width=0.5\textwidth]{./images-gspi/glock_gauss_128.png}}\\
	\subfloat[STFT, 2048-sample Hamming]{\includegraphics[width=0.5\textwidth]{./images-gspi/glock_hamm_2048.png}}
	\subfloat[Gabor transform, 2048-sample Gaussian]{\includegraphics[width=0.5\textwidth]{./images-gspi/glock_gauss_2048.png}}\\
	\subfloat[STFT, 16384-sample Hamming]{\includegraphics[width=0.5\textwidth]{./images-gspi/glock_hamm_16384.png}}
	\subfloat[Gabor transform, 16384-sample Gaussian]{\includegraphics[width=0.5\textwidth]{./images-gspi/glock_gauss_16384.png}}
...
\begin{figure}[ht]
	\centering
	\subfloat[Center frequencies, 12 bins-per-octave]{\includegraphics[width=0.325\textwidth]{./images-gspi/glock_cqt12_cf.png}}
	\subfloat[Bandwidth of Gabor atom at the Nyquist rate, 12 bins-per-octave]{\includegraphics[width=0.325\textwidth]{./images-gspi/glock_cqt12_gaborframe.png}}
	\subfloat[Constant-Q ratio, 12 bins-per-octave]{\includegraphics[width=0.325\textwidth]{./images-gspi/glock_cqt12_ratio.png}}\\
	\subfloat[Center frequencies, 24 bins-per-octave]{\includegraphics[width=0.325\textwidth]{./images-gspi/glock_cqt24_cf.png}}
	\subfloat[Bandwidth of Gabor atom at the Nyquist rate, 24 bins-per-octave]{\includegraphics[width=0.325\textwidth]{./images-gspi/glock_cqt24_gaborframe.png}}
	\subfloat[Constant-Q ratio, 24 bins-per-octave]{\includegraphics[width=0.325\textwidth]{./images-gspi/glock_cqt24_ratio.png}}\\
	\subfloat[Center frequencies, 48 bins-per-octave]{\includegraphics[width=0.325\textwidth]{./images-gspi/glock_cqt48_cf.png}}
	\subfloat[Bandwidth of Gabor atom at the Nyquist rate, 48 bins-per-octave]{\includegraphics[width=0.325\textwidth]{./images-gspi/glock_cqt48_gaborframe.png}}
	\subfloat[Constant-Q ratio, 48 bins-per-octave]{\includegraphics[width=0.325\textwidth]{./images-gspi/glock_cqt48_ratio.png}}\\
