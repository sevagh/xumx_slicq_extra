...
\begin{figure}[ht]
	...
	\hspace{0.5em}
	\subfloat[The periodicity of the sine wave is more apparent with a longer $\Delta t$, at the cost of temporally localized sample values]{\includegraphics[height=5cm]{./images-tftheory/gabor2.png}}
