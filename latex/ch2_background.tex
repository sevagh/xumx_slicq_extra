...
\begin{itemize}
	...
	\item
		Sparsity of the sources is important -- e.g., drums are vertical lines in the spectrogram, guitar is horizontal lines, etc. \cite{musicsepgood} -- indicating sparser transforms might be a good idea (i.e. an NSGT which is less blurry has more sparsity)
\end{itemize}

\begin{figure}[ht]
	\vspace{-1em}
	\centering
	\subfloat{\includegraphics[height=3.0cm]{./images-mss/mss1.png}}
	\subfloat{\includegraphics[height=3.1cm]{./images-mss/mss2.png}}
