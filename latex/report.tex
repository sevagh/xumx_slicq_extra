...
\begin{figure}[ht]
	\centering
	\subfloat[Wide window STFT (93ms)]{\includegraphics[height=5cm]{./tf_tradeoff_balasz2.png}}
	\hspace{0.5em}
	\subfloat[Narrow window STFT (6ms)]{\includegraphics[height=5cm]{./tf_tradeoff_balasz1.png}}
...
The Constant-Q transform (CQT) is time-frequency transform for musical signals, originally designed by \citet{jbrown}, the relationship between the fundamental frequency and its harmonics on a logarithmic frequency scale more clearly than the linear frequency scale of the traditional discrete Fourier transform (DFT).
...
\begin{figure}[ht]
	\centering
	\subfloat[Linear frequency spectrum]{\includegraphics[height=4.75cm]{../latex/violindft.png}}
	\subfloat[Constant-Q transform]{\includegraphics[height=4.75cm]{../latex/violincqt.png}}
...
\subsubsection{Constant-Q log}

log, octave

\subsubsection{Variable-Q log}
...
\subsection{Uses of music source separation}

\todo[inline]{purposes and uses}
