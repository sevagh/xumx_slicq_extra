...
This \hlblu{chapter} contains the results of the experiments described in Chapter \ref{ch:methodology}, and a discussion of the results. Refer to Appendix \ref{appendix:computerspec} for the hardware and software specifications of the computer which produced the results in this \hlblu{chapter}. Appendix \ref{appendix:codeavail} contains links to all of the code for the experiments and results shown in this chapter.
