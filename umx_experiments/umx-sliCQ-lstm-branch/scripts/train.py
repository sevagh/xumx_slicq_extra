...
def train(args, unmix, encoder, device, train_sampler, criterion, optimizer):
    ...
    return losses.avg, Xmag # return a data sample for tensorboard purposes
...
def main():
    ...
    for epoch in t:
        ...
        train_loss, last_Xmag = train(args, unmix, encoder, device, train_sampler, criterion, optimizer)
    ...
    if writer is not None:
        writer.add_graph(unmix, last_Xmag)
