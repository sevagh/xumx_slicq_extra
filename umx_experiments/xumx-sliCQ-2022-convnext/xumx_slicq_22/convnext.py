    ...
    def __init__(self, in_chans=3, num_classes=1000, 
        ...
        for i in range(3):
            upsample_layer = nn.Sequential(
                ...
                nn.ConvTranspose2d(dims[-1-i], dims[-2-i], kernel_size=2, stride=2, output_padding=1),
            )
            self.upsample_layers.append(upsample_layer)
        stem = nn.Sequential(
            nn.ConvTranspose2d(dims[0], in_chans, kernel_size=4, stride=4, output_padding=3),
