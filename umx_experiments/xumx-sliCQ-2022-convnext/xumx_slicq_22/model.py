...
from .convnext2 import ConvNeXt2
...
class OpenUnmixCore(nn.Module):
    def __init__(
        ...
        # super-tiny/custom size
        self.convnext = ConvNeXt2(in_chans=2, depths=[3, 3, 9, 3], dims=[24, 48, 96, 128])
...
class OpenUnmixCoreB(nn.Module):
    def __init__(
        self,
        slicq_sample_input,
        input_mean=None,
        ...
        super(OpenUnmixCoreB, self).__init__()
        ...
        # super-tiny/custom size
        self.convnext = ConvNeXt(in_chans=2, depths=[3, 3, 9, 3], dims=[24, 48, 96, 128])
...
class OpenUnmix(nn.Module):
    ...
    def __init__(
        ...
        if model_b:
            self.unmix_vocals = OpenUnmixCoreB(
